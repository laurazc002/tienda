export let productosBD = [

    {
       ...
       Description : 'Tank Française watch, small model, quartz movement. Steel case, octagonal crown in yellow gold set with a synthetic cabochon-shaped spinel, silver-grained dial, blued-steel sword-shaped hands, sapphire crystal, two-tone bracelet. Case dimensions: 25 mm x 20 mm, thickness: 6.76 mm. Water-resistant to 3 bar (approx. 30 metres).',
       popularidad: 4,
       tipo: 'reloj'
   },
   
  {
       ...
       Description : 'Tank Française watch, medium model, quartz movement. Steel case set with 26 brilliant-cut diamonds totalling 0.63 carats. Faceted crown set with a synthetic cabochon-shaped spinel. Silvered dial. Blued-steel sword-shaped hands. Sapphire crystal. Steel bracelet. Case dimensions: 30 mm x 25 mm, thickness: 7.08 mm. Water-resistant to 3 bar (approx. 30 metres).',
       popularidad: 5,
       tipo: 'reloj'
   },
   
   {
       ...
       Description : 'Tank Louis Cartier watch, large model, Manufacture mechanical movement with manual winding, calibre 1917 MC. Case in rose gold 750/1000 set with 40 brilliant-cut diamonds and beaded crown set with one brilliant-cut diamond of 0.65 carats, silvered dial, blued-steel sword-shaped hands, mineral crystal, rose gold 750/1000 bracelet. Case dimensions: 33.7 mm x 25.5 mm. Thickness: 6.6 mm. Water-resistant to 3 bar (approx. 30 metres).',
       popularidad: 3,
       tipo: 'reloj'
   },
   
   {
       ...
       Description : 'Panthère de Cartier watch, small model, quartz movement. Rose gold 750/1000 case and crown set with 37 brilliant-cut diamonds totalling 0.27 carat. Dimensions: 22 mm x 30 mm, thickness: 6 mm, dial with graduated shades of golden plum and brown forming a diagonal in the centre, sword-shaped hands, rose gold 750/1000 strap. Water-resistant to 3 bar (approx. 30 metres).',
       popularidad: 4,
       tipo: 'reloj'
   },
  
   {
       ...
       Description : 'Panthère de Cartier watch, small model, quartz movement. Case and bracelet in rose gold 750/1000 set with brilliant-cut diamonds. Crown set with a diamond, blued-steel sword-shaped hands. Dimensions: 30 mm x 23 mm, thickness: 6 mm. Water-resistant to 3 bar (approx. 30 metres).',
       popularidad: 5,
       tipo: 'reloj'
   },
